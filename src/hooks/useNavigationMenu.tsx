...
export default function useNavigationMenu() {
  ...
  useEffect(() => {
    ...
    const allNavItems = [
      ...
      {
        key: 'menu.aganceFaaliyateDriver',
        label: 'گواهی فعالیت راننده',
        is_title: false,
        href: '/aganceFaaliyateDriver',
        icon: <i className="fas fa-qrcode"></i>,
        isPermitted: hasPermitGroup([PERMIT_CONST.PERMIT_AGANCE_FAALIYATE_DRIVER_LIST]),
      },
      {
        key: 'menu.aganceMoarefinameVam',
        label: 'معرفی نامه وام',
        is_title: false,
        href: '/aganceMoarefinameVam',
        icon: <i className="fas fa-qrcode"></i>,
        isPermitted: hasPermitGroup([PERMIT_CONST.PERMIT_AGANCE_MOAREFI_NAME_VAM_LIST]),
      },
      {
        key: 'menu.aganceMoarefinameTaminEjtemaei',
        label: 'معرفی نامه اداره تامین اجتماعی',
        is_title: false,
        href: '/aganceMoarefinameTaminEjtemaei',
        icon: <i className="fas fa-qrcode"></i>,
        isPermitted: hasPermitGroup([PERMIT_CONST.PERMIT_AGANCE_MOAREFI_NAME_TAMIN_EJTEMAEI_LIST]),
      },
      {
