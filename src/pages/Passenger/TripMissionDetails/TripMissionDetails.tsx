...
const TripMissionDetails = (props:any) => {
    return (
        <div className='TripMissionDetails-component'>
            <div className='flex justify-between'>
                ...
                <div className='flex flex-col px-2 items-center whitespace-nowrap'>
                    <label className='mb-1 text-sm'>{"پژوه 405 سفید"}</label>
            ...
            <div>
                <table className='w-full'>
                    <tbody>
                        ...
                        <tr className='text-sm '><td className='px-3 pt-2 bold whitespace-nowrap align-top text-left'>{"حرکت"}</td><td className='pt-2'>{"21 اردیبهشت 1404 ساعت 15:30"}</td></tr>
                        <tr><td colSpan={2}><TitledSparator title={"مسیر"} /></td></tr>
                        <tr className='text-sm'><td className='px-3 pt-2 bold whitespace-nowrap align-top text-left'>{"مبدا"}</td><td className='pt-2' >{"خیابان 7 تیر کوچه ی بنیاد شهید سابق جنب پاساژ امام"}</td></tr>
                        ...
                        <tr className='text-sm '><td className='px-3 pt-2 bold whitespace-nowrap align-top text-left'>{"مقصد"}</td><td className='pt-2' >{"یه جایی همون طرفا که یه ساختمون بزرگی هست"}</td></tr>
                        <tr><td colSpan={2}><TitledSparator title={"مشخصات"} /></td></tr>
                        <tr className='text-sm'><td className='px-3 pt-2 bold whitespace-nowrap align-top text-left'>{"دیسپاچر"}</td><td className='pt-2' >{"محمدرضا نیک سرشت"}</td></tr>
                        ...
                        <tr className='text-sm'><td className='px-3 pt-2 bold whitespace-nowrap align-top text-left'>{"مرکز هزینه"}</td><td className='pt-2'>{"بخش فلان فلان ایریسا"}</td></tr>
                        <tr>
                            <td colSpan={2}>
                                <button className='bg-primary text-white rounded-3xl p-2 w-full mt-6'>در انتظار حرکت راننده</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
