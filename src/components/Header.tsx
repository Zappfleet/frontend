...
const Header = (props: {
  ...
  return (
    <header
      ...
      className="fixed right-0 top-0 z-999 flex w-full bg-primary  dark:bg-boxdark dark:drop-shadow-none shadow-lg"
    >
      <div className="flex flex-grow items-center justify-between py-3 px-3 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className='hidden lg:block text-white text-md bold'>
          {"سامانه ی جامع حمل و نقل زپ"}
        </div>
