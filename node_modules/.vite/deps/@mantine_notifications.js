...
function useClipboard({ timeout: timeout2 = 2e3 } = {}) {
  ...
  const handleCopyResult = (value) => {
    ...
    setCopyTimeout(window.setTimeout(() => setCopied(false), timeout2));
    setCopied(value);
  };
...
function useMediaQuery(query, initialValue, { getInitialValueInEffect } = {
  ...
  const [matches2, setMatches] = (0, import_react5.useState)(
...
function useStore(store) {
  return (0, import_react67.useSyncExternalStore)(
    store.subscribe,
    () => store.getState(),
    () => store.getState()
  );
...
// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/CSSTransition.js
var import_prop_types3 = __toESM(require_prop_types());
var import_react70 = __toESM(require_react());

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/Transition.js
var import_prop_types2 = __toESM(require_prop_types());
var import_react69 = __toESM(require_react());
var import_react_dom = __toESM(require_react_dom());

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/config.js
var config_default = {
  disabled: false
};

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/utils/PropTypes.js
...
// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/TransitionGroupContext.js
var import_react68 = __toESM(require_react());
var TransitionGroupContext_default = import_react68.default.createContext(null);

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/utils/reflow.js
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      import_react69.default.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children2 === "function" ? children2(status, childProps) : import_react69.default.cloneElement(import_react69.default.Children.only(children2), childProps))
    );
  };
  return Transition4;
...
// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/CSSTransition.js
var _addClass = function addClass2(node, classes86) {
  return node && classes86 && classes86.split(" ").forEach(function(c) {
    return addClass(node, c);
  });
};
var removeClass2 = function removeClass3(node, classes86) {
  return node && classes86 && classes86.split(" ").forEach(function(c) {
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react70.default.createElement(Transition_default, _extends({}, props, {
...
// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/ReplaceTransition.js
var import_prop_types5 = __toESM(require_prop_types());
var import_react73 = __toESM(require_react());
var import_react_dom2 = __toESM(require_react_dom());

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/TransitionGroup.js
var import_prop_types4 = __toESM(require_prop_types());
var import_react72 = __toESM(require_react());

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/utils/ChildMapping.js
var import_react71 = __toESM(require_react());
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react71.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react71.Children.map(children2, function(c) {
      return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    var isLeaving = (0, import_react71.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react71.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react71.isValidElement)(prevChild)) {
      children2[key] = (0, import_react71.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return import_react72.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react72.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react72.default.createElement(Component, props, children2));
  };
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react73.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react73.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react73.default.createElement(TransitionGroup_default, props, inProp ? import_react73.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react73.default.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react73.default.Children.count(props[propName]) !== 2)
      return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};

// node_modules/@mantine/notifications/node_modules/react-transition-group/esm/SwitchTransition.js
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react74.default.isValidElement(oldChildren) && import_react74.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react74.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react74.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react74.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react74.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react74.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react74.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react74.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
function useCallbackRef2(initialValue, callback) {
  var ref = (0, import_react75.useState)(function() {
    return {
      // value
      value: initialValue,
      // last callback
...
var RemoveScroll = React11.forwardRef(function(props, parentRef) {
  ...
  return React11.createElement(
    ...
    forwardProps ? React11.cloneElement(React11.Children.only(children2), __assign(__assign({}, containerProps), { ref: containerRef })) : React11.createElement(Container2, __assign({}, containerProps, { className, ref: containerRef }), children2)
  );
});
...
function isElement(value) {
  ...
  if (typeof value === "object") {
    if (value.type === import_react78.Fragment) {
      return false;
    }
    return true;
  }
...
function createSafeContext(errorMessage) {
  const Context = (0, import_react79.createContext)(null);
  const useSafeContext = () => {
    const ctx = (0, import_react79.useContext)(Context);
    if (ctx === null) {
      throw new Error(errorMessage);
    }
    return ctx;
  };
  const Provider = ({ children: children2, value }) => (0, import_jsx_runtime.jsx)(Context.Provider, { value, children: children2 });
...
function createOptionalContext(initialValue = null) {
  const Context = (0, import_react80.createContext)(initialValue);
  const useOptionalContext = () => (0, import_react80.useContext)(Context);
  const Provider = ({ children: children2, value }) => (0, import_jsx_runtime2.jsx)(Context.Provider, { value, children: children2 });
...
function useHovered() {
  const [hovered, setHovered] = (0, import_react81.useState)(-1);
...
var MantineContext = (0, import_react82.createContext)(null);
function useMantineContext() {
  const ctx = (0, import_react82.useContext)(MantineContext);
  if (!ctx) {
...
// node_modules/@mantine/core/esm/core/MantineProvider/MantineThemeProvider/MantineThemeProvider.mjs
var MantineThemeContext = (0, import_react86.createContext)(null);
var useSafeMantineTheme = () => (0, import_react86.useContext)(MantineThemeContext) || DEFAULT_THEME;
function useMantineTheme() {
  const ctx = (0, import_react86.useContext)(MantineThemeContext);
  if (!ctx) {
    throw new Error(
...
function MantineThemeProvider({
  ...
  const mergedTheme = (0, import_react86.useMemo)(
    () => mergeMantineTheme(inherit ? parentTheme : DEFAULT_THEME, theme),
    [theme, parentTheme, inherit]
  );
  return (0, import_jsx_runtime6.jsx)(MantineThemeContext.Provider, { value: mergedTheme, children: children2 });
}
...
function useProviderColorScheme({
  ...
  const media = (0, import_react93.useRef)();
  const [value, setValue] = (0, import_react93.useState)(() => manager.get(defaultColorScheme));
  const colorSchemeValue = forceColorScheme || value;
  const setColorScheme = (0, import_react93.useCallback)(
    (colorScheme) => {
      if (!forceColorScheme) {
  ...
  const clearColorScheme = (0, import_react93.useCallback)(() => {
...
function HeadlessMantineProvider({ children: children2, theme }) {
  return (0, import_jsx_runtime14.jsx)(
    MantineContext.Provider,
    {
      value: {
      ...
      children: (0, import_jsx_runtime14.jsx)(MantineThemeProvider, { theme, children: children2 })
    }
  );
}
...
function fontFamilyResolver(fontFamily) {
  if (typeof fontFamily === "string" && fontFamily in values2) {
    return values2[fontFamily];
  }
  return fontFamily;
}
...
function useCollapse({
  ...
  const setStyles = (newStyles) => {
    (0, import_react_dom3.flushSync)(() => setStylesRaw(newStyles));
  };
...
var Collapse = factory((props, ref) => {
  const {
    ...
    animateOpacity,
    ...others
  } = useProps("Collapse", defaultProps2, props);
  const theme = useMantineTheme();
  ...
  if (duration === 0) {
    return opened ? (0, import_jsx_runtime33.jsx)(Box, { ...others, children: children2 }) : null;
  }
...
var ScrollAreaRoot = (0, import_react120.forwardRef)((_props, ref) => {
  const props = useProps("ScrollAreaRoot", defaultProps3, _props);
...
var Scrollbar = (0, import_react122.forwardRef)((props, forwardedRef) => {
  ...
  (0, import_react122.useEffect)(handleThumbPositionChange, [sizes, handleThumbPositionChange]);
...
var ScrollAreaScrollbarVisible = (0, import_react125.forwardRef)((props, forwardedRef) => {
  ...
  const [sizes, setSizes] = (0, import_react125.useState)({
    content: 0,
    viewport: 0,
...
var Thumb = (0, import_react130.forwardRef)((props, forwardedRef) => {
  ...
  const removeUnlinkedScrollListenerRef = (0, import_react130.useRef)();
...
var ScrollAreaViewport = (0, import_react131.forwardRef)(
  ({ children: children2, style, ...others }, ref) => {
    const ctx = useScrollAreaContext();
    ...
    return (0, import_jsx_runtime47.jsx)(
      Box,
      {
        ...
        children: (0, import_jsx_runtime47.jsx)("div", { style: { minWidth: "100%", display: "table" }, ref: ctx.onContentChange, children: children2 })
      }
    );
  }
);
...
var ScrollArea = factory((_props, ref) => {
  const props = useProps("ScrollArea", defaultProps4, _props);
  const {
    classNames,
    className,
    style,
...
var ScrollAreaAutosize = factory((props, ref) => {
  const {
    ...
    vars,
    ...others
  } = useProps("ScrollAreaAutosize", defaultProps4, props);
...
var UnstyledButton = polymorphicFactory(
  (_props, ref) => {
    const props = useProps("UnstyledButton", defaultProps5, _props);
    const {
      className,
      component = "button",
      __staticSelector,
...
var VisuallyHidden = factory((_props, ref) => {
  const props = useProps("VisuallyHidden", defaultProps6, _props);
...
var index = typeof document !== "undefined" ? import_react136.useLayoutEffect : import_react136.useEffect;
...
var index2 = typeof document !== "undefined" ? import_react137.useLayoutEffect : import_react137.useEffect;
...
var FloatingListContext = React17.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function FloatingList(props) {
  ...
  const [map, setMap] = React17.useState(() => /* @__PURE__ */ new Map());
  const register = React17.useCallback((node) => {
    setMap((prevMap) => new Map(prevMap).set(node, null));
  }, []);
  const unregister = React17.useCallback((node) => {
    setMap((prevMap) => {
  ...
  return React17.createElement(FloatingListContext.Provider, {
...
function useListItem(props) {
  ...
  const {
    ...
    elementsRef,
    labelsRef
  } = React17.useContext(FloatingListContext);
  const [index$1, setIndex] = React17.useState(null);
...
function renderJsx(render, computedProps) {
  ...
  if (render) {
    return React17.cloneElement(render, computedProps);
  }
  return React17.createElement("div", computedProps);
}
var CompositeContext = React17.createContext({
  activeIndex: 0,
  onNavigate: () => {
  }
});
...
var Composite = React17.forwardRef(function Composite2(props, forwardedRef) {
  const {
    render,
    orientation = "both",
    loop = true,
  ...
  const [internalActiveIndex, internalSetActiveIndex] = React17.useState(0);
  ...
  return React17.createElement(CompositeContext.Provider, {
    value: contextValue
  }, React17.createElement(FloatingList, {
    elementsRef
  }, renderJsx(render, computedProps)));
});
var CompositeItem = React17.forwardRef(function CompositeItem2(props, forwardedRef) {
  const {
    render,
    ...domProps
  } = props;
  ...
  const {
    activeIndex,
    onNavigate
  } = React17.useContext(CompositeContext);
  const {
    ref,
    index: index5
  } = useListItem();
...
function useFloatingId() {
  const [id, setId] = React17.useState(() => serverHandoffComplete ? genId() : void 0);
  index2(() => {
    if (id == null) {
      setId(genId());
    }
...
var FloatingArrow = React17.forwardRef(function FloatingArrow2(props, ref) {
  const {
    context: {
      placement,
      elements: {
  ...
  return React17.createElement("svg", _extends2({}, rest, {
    "aria-hidden": true,
    ref,
  ...
  }), computedStrokeWidth > 0 && React17.createElement("path", {
    ...
    d: dValue
  }), React17.createElement("clipPath", {
    id: clipPathId
...
var FloatingNodeContext = React17.createContext(null);
var FloatingTreeContext = React17.createContext(null);
var useFloatingParentNodeId = () => {
  var _React$useContext;
  return ((_React$useContext = React17.useContext(FloatingNodeContext)) == null ? void 0 : _React$useContext.id) || null;
};
var useFloatingTree = () => React17.useContext(FloatingTreeContext);
function createAttribute(name) {
  return "data-floating-ui-" + name;
}
function useLatestRef2(value) {
  const ref = (0, import_react137.useRef)(value);
  index2(() => {
    ref.current = value;
  });
  return ref;
...
function useHover2(context, props) {
  ...
  const timeoutRef = React17.useRef(-1);
  const handlerRef = React17.useRef();
  const restTimeoutRef = React17.useRef(-1);
  const blockMouseMoveRef = React17.useRef(true);
  const performedPointerEventsMutationRef = React17.useRef(false);
  const unbindMouseMoveRef = React17.useRef(() => {
  });
  const isHoverOpen = React17.useCallback(() => {
  ...
  const closeWithDelay = React17.useCallback(function(event, runElseBranch, reason) {
...
var FloatingDelayGroupContext = React17.createContext({
  delay: 0,
  initialDelay: 0,
  timeoutMs: 0,
  currentId: null,
...
var useDelayGroupContext = () => React17.useContext(FloatingDelayGroupContext);
function FloatingDelayGroup(props) {
  ...
  const [state, setState] = React17.useReducer((prev, next) => ({
    ...prev,
    ...next
  }), {
    delay,
  ...
  const initialCurrentIdRef = React17.useRef(null);
  const setCurrentId = React17.useCallback((currentId) => {
    setState({
      currentId
    });
  }, []);
  ...
  return React17.createElement(FloatingDelayGroupContext.Provider, {
    value: React17.useMemo(() => ({
      ...state,
      setState,
      setCurrentId
...
var FocusGuard = React17.forwardRef(function FocusGuard2(props, ref) {
  ...
  return React17.createElement("span", _extends2({}, props, restProps));
});
var PortalContext = React17.createContext(null);
var attr = createAttribute("portal");
var VisuallyHiddenDismiss = React17.forwardRef(function VisuallyHiddenDismiss2(props, ref) {
  return React17.createElement("button", _extends2({}, props, {
    type: "button",
    ref,
    tabIndex: -1,
    style: HIDDEN_STYLES
...
var FloatingOverlay = React17.forwardRef(function FloatingOverlay2(props, ref) {
  const {
    lockScroll = false,
    ...rest
  } = props;
  ...
  return React17.createElement("div", _extends2({
    ref
  }, rest, {
    style: {
      position: "fixed",
...
function useDismiss(context, props) {
  ...
  const insideReactTreeRef = React17.useRef(false);
  const endedOrStartedInsideRef = React17.useRef(false);
  const {
...
function useFloatingRootContext(options) {
  ...
  const dataRef = React17.useRef({});
  const [events] = React17.useState(() => createPubSub());
  ...
  const [positionReference, setPositionReference] = React17.useState(elementsProp.reference);
...
function useFloating2(options) {
  ...
  const [_domReference, setDomReference] = React17.useState(null);
  const [positionReference, _setPositionReference] = React17.useState(null);
...
function useInteractions(propsList) {
  ...
  const getReferenceProps = React17.useCallback(
    (userProps) => mergeProps(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    deps
  );
  const getFloatingProps = React17.useCallback(
    (userProps) => mergeProps(userProps, propsList, "floating"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    deps
  );
  const getItemProps = React17.useCallback(
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow3 = (0, import_react139.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function FocusTrap({
  ...
  const ref = useMergedRef(focusTrapRef, children2 == null ? void 0 : children2.ref);
  if (!isElement(children2)) {
    return children2;
  }
  return (0, import_react141.cloneElement)(children2, { [refProp]: ref });
}
...
var defaultProps8 = {};
var Portal = (0, import_react142.forwardRef)((props, ref) => {
  const { children: children2, target, ...others } = useProps("Portal", defaultProps8, props);
  const [mounted, setMounted] = (0, import_react142.useState)(false);
  const nodeRef = (0, import_react142.useRef)(null);
  useIsomorphicEffect(() => {
    setMounted(true);
  ...
  return (0, import_react_dom7.createPortal)((0, import_jsx_runtime56.jsx)(import_jsx_runtime56.Fragment, { children: children2 }), nodeRef.current);
});
Portal.displayName = "@mantine/core/Portal";

// node_modules/@mantine/core/esm/components/Portal/OptionalPortal.mjs
var import_jsx_runtime57 = __toESM(require_jsx_runtime(), 1);
function OptionalPortal({ withinPortal = true, children: children2, ...others }) {
  if (withinPortal) {
    return (0, import_jsx_runtime57.jsx)(Portal, { ...others, children: children2 });
  }
  return (0, import_jsx_runtime57.jsx)(import_jsx_runtime57.Fragment, { children: children2 });
}
...
function useTransition({
  ...
  const shouldReduceMotion = useReducedMotion();
  const reduceMotion = theme.respectReducedMotion ? shouldReduceMotion : false;
  const [transitionDuration, setTransitionDuration] = (0, import_react144.useState)(reduceMotion ? 0 : duration);
  const [transitionStatus, setStatus] = (0, import_react144.useState)(mounted ? "entered" : "exited");
  const timeoutRef = (0, import_react144.useRef)(-1);
  const rafRef = (0, import_react144.useRef)(-1);
  const handleStateChange = (shouldMount) => {
    ...
    if (newTransitionDuration === 0) {
      ...
      rafRef.current = requestAnimationFrame(() => {
        import_react_dom8.default.flushSync(() => {
...
function Transition2({
  ...
  if (transitionDuration === 0) {
    return mounted ? (0, import_jsx_runtime60.jsx)(import_jsx_runtime60.Fragment, { children: children2({}) }) : keepMounted ? children2({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children2({ display: "none" }) : null : (0, import_jsx_runtime60.jsx)(import_jsx_runtime60.Fragment, { children: children2(
    getTransitionStyles({
      transition,
...
Transition2.displayName = "@mantine/core/Transition";
...
var PopoverTarget = factory((props, ref) => {
  ...
  const ctx = usePopoverContext();
  const targetRef = useMergedRef(ctx.reference, children2.ref, ref);
  const accessibleProps = ctx.withRoles ? {
  ...
  return (0, import_react147.cloneElement)(children2, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
    className: clsx_default(ctx.targetProps.className, forwardedProps.className, children2.props.className),
    [refProp]: targetRef,
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react148.useState)(0);
...
function Popover(_props) {
  ...
  const arrowRef = (0, import_react152.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react152.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react152.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react152.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react152.useCallback)(
    (node) => {
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react154.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime64.jsxs)(Box, { component: "span", className: clsx_default(classes6.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react155.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime65.jsxs)(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react156.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsx)(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
var Loader = factory((_props, ref) => {
  ...
  if (children2) {
    return (0, import_jsx_runtime67.jsx)(Box, { ...getStyles2("root"), ref, ...others, children: children2 });
  }
...
var ActionIcon = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime69.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        (0, import_jsx_runtime69.jsx)(Transition2, { mounted: !!loading, transition: "slide-down", duration: 150, children: (transitionStyles) => (0, import_jsx_runtime69.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime69.jsx)(Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps }) }) }),
        (0, import_jsx_runtime69.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("icon"), children: children2 })
      ]
    }
  );
});
...
var CloseIcon = (0, import_react160.forwardRef)(
...
function filterFalsyChildren(children2) {
  return import_react162.Children.toArray(children2).filter(Boolean);
}
...
var Group = factory((_props, ref) => {
  ...
  const filteredChildren = filterFalsyChildren(children2);
...
var Overlay = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime73.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ center, fixed }, mod], ...others, children: children2 });
});
...
function useLockScroll({ opened, transitionDuration }) {
  const [shouldLockScroll, setShouldLockScroll] = (0, import_react166.useState)(opened);
  const timeout2 = (0, import_react166.useRef)();
...
function useModal({
  ...
  const _id = useId(id);
  const [titleMounted, setTitleMounted] = (0, import_react167.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react167.useState)(false);
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBase.mjs
var ModalBase = (0, import_react168.forwardRef)(
  ({
    keepMounted,
    opened,
    onClose,
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseBody.mjs
var ModalBaseBody = (0, import_react170.forwardRef)(
...
var ModalBaseCloseButton = (0, import_react171.forwardRef)(
...
var ModalBaseContent = (0, import_react172.forwardRef)(
...
var ModalBaseHeader = (0, import_react173.forwardRef)(
  ({ className, ...others }, ref) => {
    const ctx = useModalBaseContext();
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseOverlay.mjs
var ModalBaseOverlay = (0, import_react174.forwardRef)(
  ({ onClick, transitionProps, style, ...others }, ref) => {
    const ctx = useModalBaseContext();
    const transition = useModalTransition(transitionProps);
    return (0, import_jsx_runtime80.jsx)(Transition2, { mounted: ctx.opened, ...transition, transition: "fade", children: (transitionStyles) => (0, import_jsx_runtime80.jsx)(
      Overlay,
      {
        ref,
        fixed: true,
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseTitle.mjs
var ModalBaseTitle = (0, import_react176.forwardRef)(
  ({ className, ...others }, ref) => {
...
function NativeScrollArea({ children: children2 }) {
  return (0, import_jsx_runtime82.jsx)(import_jsx_runtime82.Fragment, { children: children2 });
}
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime88.jsx)(import_react182.Fragment, { children: inputContainer(children2) }, "input");
...
function useFloatingIndicator({
  ...
  const transitionTimeout = (0, import_react187.useRef)();
  ...
  const targetResizeObserver = (0, import_react187.useRef)();
  const parentResizeObserver = (0, import_react187.useRef)();
...
var FloatingIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime94.jsx)(Box, { ref: mergedRef, mod: [{ initialized, hidden: hidden2 }, mod], ...getStyles2("root"), ...others });
});
  ...
  const content = (0, import_jsx_runtime98.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime98.jsx)("span", { ...ctx.getStyles("label", { classNames, styles }), children: children2 }),
...
var AccordionPanel = factory((props, ref) => {
  const { classNames, className, style, styles, vars, children: children2, ...others } = useProps(
    "AccordionPanel",
    defaultProps29,
    props
  );
  ...
  return (0, import_jsx_runtime100.jsx)(
    Collapse,
    {
      ...
      children: (0, import_jsx_runtime100.jsx)("div", { ...ctx.getStyles("content", { classNames, styles }), children: children2 })
    }
  );
});
...
function Accordion(_props) {
  ...
  return (0, import_jsx_runtime101.jsx)(
    AccordionProvider,
    {
      ...
      children: (0, import_jsx_runtime101.jsx)(Box, { ...getStyles2("root"), id: uid, ...others, variant, "data-accordion": true, children: children2 })
    }
  );
}
    ...
    Box,
    {
      ...
      children: (0, import_jsx_runtime103.jsxs)("div", { ...getStyles2("wrapper"), children: [
        ...
        (0, import_jsx_runtime103.jsxs)("div", { ...getStyles2("body"), children: [
          ...
          children2 && (0, import_jsx_runtime103.jsx)("div", { id: bodyId, ...getStyles2("message"), "data-variant": variant, children: children2 })
        ] }),
...
function useResizing({ transitionDuration, disabled }) {
  ...
  const resizingTimeout = (0, import_react215.useRef)();
  const disabledTimeout = (0, import_react215.useRef)();
...
var ComboboxDropdownTarget = factory((props, ref) => {
  const { children: children2, refProp } = useProps("ComboboxDropdownTarget", defaultProps45, props);
  useComboboxContext();
  if (!isElement(children2)) {
    throw new Error(
  ...
  return (0, import_jsx_runtime127.jsx)(Popover.Target, { ref, refProp, children: children2 });
});
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react225.cloneElement)(children2, {
    ...targetProps,
    ...others,
    [refProp]: useMergedRef(ref, ctx.store.targetRef, children2 == null ? void 0 : children2.ref)
  });
});
...
var ComboboxGroup = factory((props, ref) => {
  const { classNames, className, style, styles, vars, children: children2, label, ...others } = useProps(
    "ComboboxGroup",
    defaultProps49,
    props
  );
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react232.cloneElement)(children2, {
    ...targetProps,
    ...others
  });
...
function InputsGroupFieldset({ children: children2, role }) {
  const ctx = useInputWrapperContext();
  if (!ctx) {
    return (0, import_jsx_runtime142.jsx)(import_jsx_runtime142.Fragment, { children: children2 });
  }
  return (0, import_jsx_runtime142.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children: children2 });
}

// node_modules/@mantine/core/esm/components/Checkbox/CheckboxGroup/CheckboxGroup.mjs
var defaultProps57 = {};
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children: children2, readOnly, ...others } = useProps("CheckboxGroup", defaultProps57, props);
  ...
  return (0, import_jsx_runtime143.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: (0, import_jsx_runtime143.jsx)(
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime143.jsx)(InputsGroupFieldset, { role: "group", children: children2 })
    }
  ) });
});
...
function OptionsDropdown({
  ...
  return (0, import_jsx_runtime147.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, children: (0, import_jsx_runtime147.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react247.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes27,
  ...
  return (0, import_jsx_runtime151.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error2 ? (0, import_jsx_runtime151.jsx)("span", { ...getStyles2("placeholder"), title: alt, children: children2 || (0, import_jsx_runtime151.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime151.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles2("image"),
  ...
  return (0, import_jsx_runtime153.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime153.jsx)("span", { ...getStyles2("label"), children: children2 }),
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react251.Children.toArray(children2).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react251.cloneElement)(child, {
      ...
      key: index5
    }) : (0, import_react251.createElement)("div", { ...getStyles2("breadcrumb"), key: index5 }, child);
    acc.push(item);
    if (index5 !== array.length - 1) {
      acc.push(
        (0, import_react251.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index5}` }, separator)
      );
    }
    return acc;
  }, []);
...
var Button = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime158.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime158.jsx)(Transition2, { mounted: !!loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime158.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime158.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime158.jsxs)("span", { ...getStyles2("inner"), children: [
          ...
          (0, import_jsx_runtime158.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("label"), children: children2 }),
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const { classNames, className, style, styles, unstyled, vars, children: children2, padding, ...others } = props;
  const getStyles2 = useStyles({
    name: "Card",
    props,
    classes: classes34,
  ...
  const _children = import_react257.Children.toArray(children2);
...
function ChipGroup(props) {
  const { value, defaultValue, onChange, multiple, children: children2 } = useProps(
    "ChipGroup",
    defaultProps73,
    props
  );
  ...
  return (0, import_jsx_runtime164.jsx)(ChipGroupProvider, { value: { isChipSelected, onChange: handleChange, multiple }, children: children2 });
}
        ...
        (0, import_jsx_runtime165.jsxs)(
          "label",
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime165.jsx)("span", { children: children2 })
            ]
          }
        )
      ]
  ...
  return (0, import_jsx_runtime167.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime167.jsx)("span", { ...getStyles2("childrenOverlay"), children: children2 })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react265.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime169.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react266.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
var Swatches = (0, import_react270.forwardRef)(
  ({
    ...
    const colors = data.map((color, index5) => (0, import_react270.createElement)(
      ColorSwatch,
      {
...
function CopyButton(props) {
  const { children: children2, timeout: timeout2, value, ...others } = useProps("CopyButton", defaultProps82, props);
  const clipboard = useClipboard({ timeout: timeout2 });
  const copy = () => clipboard.copy(value);
  return (0, import_jsx_runtime179.jsx)(import_jsx_runtime179.Fragment, { children: children2({ copy, copied: clipboard.copied, ...others }) });
}
...
var Dialog = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime180.jsx)(
    Affix,
    {
      ...
      portalProps,
      unstyled,
      children: (0, import_jsx_runtime180.jsx)(Transition2, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime180.jsxs)(
        Paper,
        {
          unstyled,
...
var DrawerContent = factory((_props, ref) => {
  ...
  const { classNames, className, style, styles, vars, children: children2, radius, ...others } = props;
  const ctx = useDrawerContext();
  ...
  return (0, import_jsx_runtime185.jsx)(
    ModalBaseContent,
    {
      ...
      children: (0, import_jsx_runtime185.jsx)(Scroll, { style: { height: "100vh" }, children: children2 })
    }
  );
});
...
var Drawer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime190.jsxs)(DrawerRoot, { ref, ...others, children: [
    ...
    (0, import_jsx_runtime190.jsxs)(DrawerContent, { children: [
      ...
      (0, import_jsx_runtime190.jsx)(DrawerBody, { children: children2 })
    ] })
  ] });
});
...
var FileButton = (0, import_react288.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children: children2,
    ...
    const inputRef = (0, import_react288.useRef)();
    const onClick = () => {
      var _a;
...
var _FileInput = factory((_props, ref) => {
  ...
  const resetRef = (0, import_react289.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    onChange,
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react290.useRef)(-1);
  const closeTimeout = (0, import_react290.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react290.useEffect)(() => clearTimeouts, []);
...
var Grid = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime198.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns }, children: [
    ...
    (0, import_jsx_runtime198.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime198.jsx)("div", { ...getStyles2("inner"), children: children2 }) })
  ] });
});
...
var Highlight = polymorphicFactory((props, ref) => {
  const { unstyled, children: children2, highlight, highlightStyles, color, ...others } = useProps(
    "Highlight",
    defaultProps99,
    props
  );
  const highlightChunks = highlighter(children2, highlight);
...
function HoverCardDropdown(props) {
  ...
  return (0, import_jsx_runtime203.jsx)(Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others, children: children2 });
}
...
var HoverCardTarget = (0, import_react301.forwardRef)((props, ref) => {
  ...
  const ctx = useHoverCardContext();
  const onMouseEnter = createEventHandler(children2.props.onMouseEnter, ctx.openDropdown);
  const onMouseLeave = createEventHandler(children2.props.onMouseLeave, ctx.closeDropdown);
  const eventListeners = { onMouseEnter, onMouseLeave };
  return (0, import_jsx_runtime204.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react301.cloneElement)(
    children2,
...
function HoverCard(props) {
  ...
  return (0, import_jsx_runtime205.jsx)(HoverCardContextProvider, { value: { openDropdown, closeDropdown }, children: (0, import_jsx_runtime205.jsx)(Popover, { ...others, opened, __staticSelector: "HoverCard", children: children2 }) });
}
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react304.useState)(!src);
  (0, import_react304.useEffect)(() => setError(!src), [src]);
  const getStyles2 = useStyles({
    name: "Image",
    classes: classes48,
    props,
...
var index3 = import_react307.useLayoutEffect;
var use_isomorphic_layout_effect_browser_esm_default = index3;

// node_modules/use-latest/dist/use-latest.esm.js
var useLatest = function useLatest2(value) {
  var ref = React18.useRef(value);
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = (0, import_react308.useRef)();
  return (0, import_react308.useCallback)(function(instance) {
...
var TextareaAutosize = function TextareaAutosize2(_ref, userRef) {
  ...
  };
  {
    ...
    return React19.createElement("textarea", _extends({}, props, {
      onChange: handleChange,
      ref
    }));
  }
};
var index4 = React19.forwardRef(TextareaAutosize);
...
var ListItem = factory((_props, ref) => {
  ...
  const { classNames, className, style, styles, vars, icon, children: children2, mod, ...others } = props;
  ...
  return (0, import_jsx_runtime213.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime213.jsxs)("div", { ...ctx.getStyles("itemWrapper", stylesApiProps), children: [
        ...
        (0, import_jsx_runtime213.jsx)("span", { ...ctx.getStyles("itemLabel", stylesApiProps), children: children2 })
      ] })
    }
  );
});
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime215.jsx)(Transition2, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime215.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react319.useRef)();
  ...
  return (0, import_jsx_runtime219.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        ...
        children2 && (0, import_jsx_runtime219.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children: children2 }),
...
var MenuTarget = (0, import_react321.forwardRef)((props, ref) => {
  const { children: children2, refProp, ...others } = useProps("MenuTarget", defaultProps115, props);
  if (!isElement(children2)) {
    throw new Error(
  ...
  const ctx = useMenuContext();
  const onClick = createEventHandler(children2.props.onClick, () => {
  ...
  const onMouseLeave = createEventHandler(children2.props.onMouseLeave, () => {
  ...
  return (0, import_jsx_runtime221.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react321.cloneElement)(children2, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
var ModalContent = factory((_props, ref) => {
  ...
  const { classNames, className, style, styles, vars, children: children2, ...others } = props;
  const ctx = useModalContext();
  const Scroll = ctx.scrollAreaComponent || NativeScrollArea;
...
var Modal = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime231.jsxs)(ModalRoot, { ref, radius, ...others, children: [
    ...
    (0, import_jsx_runtime231.jsxs)(ModalContent, { radius, children: [
      ...
      (0, import_jsx_runtime231.jsx)(ModalBody, { children: children2 })
    ] })
  ] });
});
...
var Pill = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime235.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime235.jsx)("span", { ...getStyles2("label"), children: children2 }),
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react338.useRef)();
...
var MultiSelect = factory((_props, ref) => {
  ...
  const values3 = _value.map((item, index5) => {
    var _a, _b;
...
var NativeSelect = factory((props, ref) => {
  const { data, children: children2, size: size4, error: error2, rightSection, unstyled, ...others } = useProps(
    "NativeSelect",
    defaultProps130,
    props
  );
...
var NavLink = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime242.jsxs)(import_jsx_runtime242.Fragment, { children: [
    ...
    (0, import_jsx_runtime242.jsx)(Collapse, { in: _opened, ...getStyles2("collapse"), children: (0, import_jsx_runtime242.jsx)("div", { ...getStyles2("children"), children: children2 }) })
  ] });
});
    ...
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime243.jsxs)("div", { ...getStyles2("body"), children: [
          ...
          (0, import_jsx_runtime243.jsx)(Box, { ...getStyles2("description"), mod: { "data-with-title": !!title }, children: children2 })
        ] }),
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var _onValueChange = function(newValues2, sourceInfo) {
    if (newValues2.formattedValue !== values3.formattedValue) {
      setValues({
...
function NumberFormatBase(props) {
  ...
  var _onValueChange = function(values3, source) {
    lastUpdatedValue.current = { formattedValue: values3.formattedValue, numAsString: values3.value };
    onFormattedValueChange(values3, source);
  };
  var ref$1 = (0, import_react344.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react344.useRef)(null);
  var timeout2 = (0, import_react344.useRef)({
  ...
  (0, import_react344.useEffect)(function() {
    ...
    return function() {
      ...
      clearTimeout(timeout2.current.focusTimeout);
    };
  }, []);
  var _format = format2;
  ...
  var setPatchedCaretPosition = function(el, caretPos, currentValue) {
    ...
    timeout2.current.setCaretTimeout = setTimeout(function() {
  ...
  var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react344.useLayoutEffect : import_react344.useEffect;
  ...
  var _onFocus = function(e) {
    ...
    timeout2.current.focusTimeout = setTimeout(function() {
      var selectionStart = el.selectionStart;
      var selectionEnd = el.selectionEnd;
      var value = el.value;
      if (value === void 0)
...
var NumberInput = factory((_props, ref) => {
  ...
  const incrementRef = (0, import_react346.useRef)();
  ...
  const decrementRef = (0, import_react346.useRef)();
...
function PaginationIcon({ style, children: children2, path, ...others }) {
...
function createPinArray(length, value) {
  ...
  const values3 = new Array(length).fill("");
  if (value) {
    const splitted = value.trim().split("");
    for (let i = 0; i < Math.min(length, splitted.length); i += 1) {
      values3[i] = splitted[i] === " " ? "" : splitted[i];
    }
  }
  return values3;
}
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children: children2, name, readOnly, ...others } = useProps("RadioGroup", defaultProps146, props);
  ...
  return (0, import_jsx_runtime266.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size4, name: _name }, children: (0, import_jsx_runtime266.jsx)(
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime266.jsx)(InputsGroupFieldset, { role: "radiogroup", children: children2 })
    }
  ) });
});
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react370.useState)(false);
  const boundaryRef = (0, import_react370.useRef)();
...
var TooltipFloating = factory((_props, ref) => {
  ...
  const targetRef = useMergedRef(boundaryRef, children2.ref, ref);
  const onMouseEnter = (event) => {
    var _a, _b;
    (_b = (_a = children2.props).onMouseEnter) == null ? void 0 : _b.call(_a, event);
    handleMouseMove(event);
    setOpened(true);
  };
  const onMouseLeave = (event) => {
    var _a, _b;
    (_b = (_a = children2.props).onMouseLeave) == null ? void 0 : _b.call(_a, event);
    setOpened(false);
  };
  return (0, import_jsx_runtime275.jsxs)(import_jsx_runtime275.Fragment, { children: [
    ...
    (0, import_react372.cloneElement)(children2, {
      ...children2.props,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
function TooltipGroup(props) {
  const { openDelay, closeDelay, children: children2 } = useProps("TooltipGroup", defaultProps151, props);
  return (0, import_jsx_runtime276.jsx)(TooltipGroupProvider, { value: true, children: (0, import_jsx_runtime276.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children: children2 }) });
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react376.useState)(false);
...
var Tooltip = factory((_props, ref) => {
  ...
  const targetRef = useMergedRef(tooltip.reference, children2.ref, ref);
  ...
  return (0, import_jsx_runtime277.jsxs)(import_jsx_runtime277.Fragment, { children: [
    ...
    (0, import_react378.cloneElement)(
      ...
      tooltip.getReferenceProps({
        ...
        [refProp]: targetRef,
        className: clsx_default(className, children2.props.className),
        ...children2.props
      })
    )
  ] });
...
function getBreakpoints(values3) {
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime284.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react388.forwardRef)(
...
var Thumb3 = (0, import_react389.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react389.useState)(false);
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset4, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react390.createElement)(
    Box,
    {
...
var Slider = factory((_props, ref) => {
  ...
  const root = (0, import_react392.useRef)();
  const thumb = (0, import_react392.useRef)();
  const position = getPosition({ value: _value, min: min2, max: max2 });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react392.useCallback)(
    ({ x }) => {
      if (!disabled) {
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react393.useState)(-1);
  ...
  const thumbs = (0, import_react393.useRef)([]);
  const thumbIndex = (0, import_react393.useRef)(void 0);
  const positions = [
...
var Spoiler = factory((_props, ref) => {
  ...
  const [show, setShowState] = (0, import_react395.useState)(initialState);
      ...
      children: [
        ...
        (0, import_jsx_runtime293.jsx)(
          "div",
          {
            ...
            role: "region",
            id: regionId,
            children: (0, import_jsx_runtime293.jsx)("div", { ref: contentRef, children: children2 })
          }
        )
      ]
    }
      ...
      children: [
        withIcon && (0, import_jsx_runtime296.jsxs)("span", { ...ctx.getStyles("stepWrapper", stylesApi), children: [
          (0, import_jsx_runtime296.jsxs)("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes, children: [
            (0, import_jsx_runtime296.jsx)(Transition2, { mounted: state === "stepCompleted", transition: "pop", duration: 200, children: (transitionStyles) => (0, import_jsx_runtime296.jsx)(
              "span",
              {
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react399.Children.toArray(children2);
  ...
  const items = _children.reduce((acc, item, index5) => {
    ...
    acc.push(
      (0, import_react399.cloneElement)(item, {
    ...
    if (orientation === "horizontal" && index5 !== _children.length - 1) {
      acc.push(
        (0, import_react399.createElement)(
          "div",
          {
...
var SwitchGroupContext = (0, import_react400.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react400.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children: children2, readOnly, ...others } = useProps("SwitchGroup", defaultProps165, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime298.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: (0, import_jsx_runtime298.jsx)(
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime298.jsx)(InputsGroupFieldset, { role: "group", children: children2 })
    }
  ) });
});
...
var TableScrollContainer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime303.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime303.jsx)("div", { ...getStyles2("scrollContainerInner"), children: children2 })
    }
  );
});
    ...
    TableProvider,
    {
      ...
      children: (0, import_jsx_runtime304.jsx)(
        Box,
        {
          ...
          ...getStyles2("table"),
          ...others,
          children: children2 || !!data && (0, import_jsx_runtime304.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
var TabsList = factory((_props, ref) => {
  ...
  const { children: children2, className, grow, justify, classNames, styles, style, mod, ...others } = props;
...
var TabsPanel = factory((_props, ref) => {
  ...
  const { children: children2, className, value, classNames, styles, style, mod, ...others } = props;
  const ctx = useTabsContext();
  const active = ctx.value === value;
  const content = ctx.keepMounted || props.keepMounted ? children2 : active ? children2 : null;
  ...
  return (0, import_jsx_runtime308.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        ...
        children2 && (0, import_jsx_runtime308.jsx)("span", { ...ctx.getStyles("tabLabel", stylesApiProps), children: children2 }),
...
var TagsInput = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react413.useRef)(null);
  ...
  const values3 = _value.map((item, index5) => (0, import_jsx_runtime311.jsx)(
    Pill,
    {
    ...
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime315.jsxs)("div", { ...ctx.getStyles("itemBody", stylesApiProps), children: [
          ...
          (0, import_jsx_runtime315.jsx)("div", { ...ctx.getStyles("itemContent", stylesApiProps), children: children2 })
        ] })
      ]
    }
  );
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react418.Children.toArray(children2);
  const items = _children.map(
    (item, index5) => {
      var _a, _b;
      return (0, import_react418.cloneElement)(item, {
        unstyled,
        __align: align,
...
function TreeNode({
  ...
  const ref = (0, import_react421.useRef)(null);
...
function useTree({
  ...
  const toggleExpanded = (0, import_react422.useCallback)((value) => {
    setExpandedState((current) => ({ ...current, [value]: !current[value] }));
  }, []);
  const collapse = (0, import_react422.useCallback)((value) => {
    setExpandedState((current) => ({ ...current, [value]: false }));
  }, []);
  const expand = (0, import_react422.useCallback)((value) => {
...
// node_modules/@mantine/notifications/esm/NotificationContainer.mjs
var NotificationContainer = (0, import_react425.forwardRef)(
  ({ data, onHide, autoClose, ...others }, ref) => {
    const { autoClose: _autoClose, message, ...notificationProps } = data;
    const autoCloseDuration = getAutoClose(autoClose, data.autoClose);
    const autoCloseTimeout = (0, import_react425.useRef)();
...
var classes85 = { "root": "m_b37d9ac7", "notification": "m_5ed0edd0" };
...
var Notifications = factory((_props, ref) => {
  const props = useProps("Notifications", defaultProps181, _props);
  const {
    classNames,
    className,
    style,
  ...
  const shouldReduceMotion = useReducedMotion();
  const refs = (0, import_react426.useRef)({});
  const previousLength = (0, import_react426.useRef)(0);
  const reduceMotion = theme.respectReducedMotion ? shouldReduceMotion : false;
  ...
  const items = data.notifications.map(({ style: notificationStyle, ...notification }) => (0, import_jsx_runtime323.jsx)(
    Transition3,
    {
      timeout: duration,
      onEnter: () => refs.current[notification.id].offsetHeight,
      nodeRef: { current: refs.current[notification.id] },
      children: (state) => (0, import_jsx_runtime323.jsx)(
  ...
  return (0, import_jsx_runtime323.jsx)(OptionalPortal, { withinPortal, ...portalProps, children: (0, import_jsx_runtime323.jsx)(Box, { ...getStyles2("root"), ref, ...others, children: (0, import_jsx_runtime323.jsx)(TransitionGroup_default, { children: items }) }) });
});
Notifications.classes = classes85;
